...
//            Message response = this.createMessage(m.id, Message.MSG_DATA, m.src, m.messageTopicID, "",m.isRow,m.rowOrColumnNumber,m.partNumber,m.timestamp);
...
//                    System.out.print("message src"+curMessage.src+" "+(blockProposerId)+" ");
//                    System.out.println(curMessage.src.equals(blockProposerId));}
