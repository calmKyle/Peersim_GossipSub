...
// String strategy = Configuration.getString(prefix + ".forkChoiceStrategy",
// "TightForkChoice");
// switch (strategy) {
// case "CasperFFG":
...
// System.out.println("Seed message received by Node " + node.getID() + " from "
// + msg.getSender().getID());
...
// // Block newBlock = new Block(msg.getRows(), msg.getColumns(),
// validatorKeyPair);
// newBlock.initialiseDataMatrix();
// blockStorage.put(msg.getBlockID(), newBlock);

// System.out.println("New block created with ID: " + newBlock.blockID + " at
// Node " + node.getID());
...
// if (block == null) {
// System.out.println("Block ID " + msg.getBlockID() + " not found at Node " +
// node.getID());
// return;
// }

// byte[] sampleData = block.getSample(msg.getRow(), msg.getColumn());
// System.out.println("Sample message processed with data sample at Node " +
// node.getID());
...
// System.out.println("Vote message received at Node " + node.getID() + " for
// Block " + msg.getBlockID());
